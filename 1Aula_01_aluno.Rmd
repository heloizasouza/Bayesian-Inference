...
```{r, warning=FALSE}
dados <- seq(0, 1, by = 0.01)
alpha <- function(x) x + 1
beta <- function(n, x) n - x + 1

par(mfrow = c(2,2))
# -a. $n = 4$ e $x = 3$;

plot(dados, dbeta(dados, alpha(3), beta(4,3)), type = "l", col = "red", title = "a")
lines(dados, dunif(dados, 0, 1), col = "blue")

# b. $n = 12$ e $x = 9$;

plot(dados, dbeta(dados, alpha(9), beta(12, 9)),  type = "l", col = "red",  title = "b")
lines(dados, dunif(dados, 0, 1), col = "blue")

# c. $n = 60$ e $x = 45$;

plot(dados, dbeta(dados, alpha(45), beta(60,45)), type = "l", col = "red",  title = "c")
lines(dados, dunif(dados, 0, 1), col = "blue")

# d. $n = 100$ e $x = 75$.

plot(dados, dbeta(dados, alpha(75), beta(100,75)), type = "l", col = "red",  title = "d")
lines(dados, dunif(dados, 0, 1), col = "blue")
...
alpha <- function(a) 9 + a
beta <- function(b) 12 - 9 + b


par(mfrow = c(2,2))
# a. $\alpha = 1, \beta = 1$;

plot(dados, dbeta(dados, alpha(1), beta(1)), type = "l", col = "red", title = "a")
lines(dados, dunif(dados, 0, 1), col = "blue")

# b. $\alpha = 5, \beta = 5$;

plot(dados, dbeta(dados, alpha(5), beta(5)), type = "l", col = "red", title = "b")
lines(dados, dunif(dados, 0, 5), col = "blue")

# c. $\alpha = 20, \beta = 20$;

plot(dados, dbeta(dados, alpha(20), beta(20)), type = "l", col = "red", title = "c")
lines(dados, dunif(dados, 20, 20), col = "blue")

# d. $\alpha = 50, \beta = 50$.

plot(dados, dbeta(dados, alpha(50), beta(50)), type = "l", col = "red", title = "d")
lines(dados, dunif(dados, 50, 50), col = "blue")
